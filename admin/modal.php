                ...
                <div class="container-fluid">
                    ...
                    <div class="form-group" style="margin-top:10px;">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="number" class="form-control" name="staffpno" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="margin-top:10px;">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                                                <input type="number" class="form-control" name="staffsalary" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="margin-top:10px;">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="staffgender" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="margin-top:10px;">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="staffposition" required>
                            </div>
                        </div>
                    </div>
