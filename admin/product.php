...
<div class="container">
	<h1 class="page-header text-center">PRODUCTS NAME</h1>
	<div class="row">
		<div class="col-md-12">
		...
		<table class="table table-striped table-bordered">
			...
			<tbody>
				...
				<?php
					...
					$sql="select * from product left join category on category.categoryid=
				product.categoryid $where order by product.categoryid asc, productname asc";
					...
					while($row=$query->fetch_array()){
						...
						<tr>
							...
							<td>
								<a href="#editproduct<?php echo $row['productid']; ?>" data-toggle="modal" class="btn btn-success btn-sm">
								<span class="glyphicon glyphicon-pencil"></span> Edit</a> || <a href="#deleteproduct<?php echo $row['productid']; ?>" data-toggle="modal" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span> Delete</a>
