...
<article class="card-body mx-auto" style="max-width: 400px;">
    ...
    <div class="form-group input-group">
		...
		<select name="number" class="custom-select" style="max-width: 120px;">
		    <option selected="">+977</option>
		    <option value="1">+972</option>
		    <option value="2">+198</option>
		    <option value="3">+701</option>
		</select>
    	<input name="pnumber" class="form-control" placeholder="Phone number" type="text">
    </div> <!-- form-group// -->
    <div class="form-group input-group">
    	<div class="input-group-prepend">
...
if(isset($_POST['submit']))
{
 ...
 mysqli_query($con,"insert into register values ('','$fullname','$email','$number','$password','$confirm')");
